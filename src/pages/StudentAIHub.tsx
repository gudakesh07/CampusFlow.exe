...
export default function StudentAIHub() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "ai",
      content:
        "Welcome to the Academic AI Hub, Rituraj. I have synchronized with your Course Context for Physics-301 and CS-402. How can I assist your studies today?",
    },
  ]);
    ...
    try {
      ...
      const errorMsg =
        error instanceof Error
          ? error.message
          : "The knowledge core is currently unavailable.";
      setMessages((prev) => [
        ...prev,
        {
          role: "ai",
  ...
  const handleClearHistory = () => {
    setMessages([
      { role: "ai", content: "Memory cleared. Restarting session." },
    ]);
        ...
        <div className="flex justify-between items-end">
          <div>
            ...
            <p className="text-muted-foreground font-light mt-1">
              Direct access to your institution's verified knowledge base.
            </p>
          </div>
          <Badge
            variant="outline"
            className="rounded-xl px-3 py-1 bg-primary/5 border-primary/20 text-primary flex items-center gap-2"
          >
          ...
          <div className="p-4 border-b bg-background/50 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs font-bold uppercase tracking-widest">
                Active Knowledge Context: PHYS-301, CS-402
              </p>
            </div>
            <Button
                  ...
                  <div
                    className={`max-w-[80%] p-4 rounded-3xl text-sm leading-relaxed ${
                      msg.role === "user"
                        ...
                        : "bg-background shadow-sm rounded-tl-none border"
                    }`}
                  >
              ...
              {isLoading && (
                <div className="flex gap-4">
                  ...
                  <div className="bg-background shadow-sm border p-4 rounded-3xl rounded-tl-none">
                    <p className="text-xs text-muted-foreground animate-pulse italics">
                      Consulting institutional database...
                    </p>
                  </div>
                </div>
              )}
